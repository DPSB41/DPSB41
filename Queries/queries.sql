...
ORDER BY OPERATIONS.MO, CONCAT(SUBSTRING(OPERATIONS.Numéro, 2, 1), SUBSTRING(OPERATIONS.Numéro, 3, 1)), SUBSTRING(OPERATIONS.Numéro, 7, 3), SUBSTRING(OPERATIONS.Numéro, 21, 2), SUBSTRING(OPERATIONS.Numéro, 24, 2) ASC;
